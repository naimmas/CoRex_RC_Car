...
{
    QMI86_GYRO_ODR_7174P4_HZ = 0x01,
    QMI86_GYRO_ODR_3587P2_HZ = 0x02,
    QMI86_GYRO_ODR_1793P6_HZ = 0x03,
...
typedef enum en_qmi86_self_test
{
    QMI86_SELF_TEST_GYRO = 0x01,
    QMI86_SELF_TEST_ACC = 0x02,
