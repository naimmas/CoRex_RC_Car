...
static response_status_t read_calib_data(bmp388_dev_t* ppt_dev)
{
    ...
    if (ret_val == RET_OK)
    {
        temp_val = (meas_data_t)(BYTES_TO_WORD(reg_data[0U], reg_data[1U]));
        pt_curr_driver->calib_data.nvm_par_t1 =
          temp_val / BMP388_CALIB_COEFF_T1;
        temp_val = (meas_data_t)(BYTES_TO_WORD(reg_data[2U], reg_data[3U]));
        ...
        temp_val =
          (meas_data_t)((int16_t)BYTES_TO_WORD(reg_data[5U], reg_data[6U]));
        pt_curr_driver->calib_data.nvm_par_p1 =
          (temp_val - (meas_data_t)(1 << 14)) / BMP388_CALIB_COEFF_P1;
        temp_val =
          (meas_data_t)((int16_t)BYTES_TO_WORD(reg_data[7U], reg_data[8U]));
        ...
        temp_val = (meas_data_t)(BYTES_TO_WORD(reg_data[11U], reg_data[12U]));
        pt_curr_driver->calib_data.nvm_par_p5 =
          temp_val / BMP388_CALIB_COEFF_P5;
        temp_val = (meas_data_t)(BYTES_TO_WORD(reg_data[13U], reg_data[14U]));
        ...
        temp_val =
          (meas_data_t)((int16_t)BYTES_TO_WORD(reg_data[17U], reg_data[18U]));
...
static bmp388_status_t read_sens_time(bmp388_dev_t* ppt_dev)
{
    ...
    if (api_ret_val == RET_OK)
    {
        ...
        ppt_dev->data.sensortime = BYTES_TO_DWORD(time_reg_data[0U],
                                                  time_reg_data[1U],
                                                  time_reg_data[2U],
                                                  0U);
    }
    ...
    else
    {
        ...
        if (api_ret_val == RET_OK)
        {
            pt_curr_driver->raw_data.pressure =
              BYTES_TO_DWORD(pres_reg_data[0U],
                             pres_reg_data[1U],
                             pres_reg_data[2U],
                             0U);
    ...
    else
    {
        ...
        if (api_ret_val == RET_OK)
        {
            pt_curr_driver->raw_data.temperature =
              BYTES_TO_DWORD(temp_reg_data[0U],
                             temp_reg_data[1U],
                             temp_reg_data[2U],
                             0U);
